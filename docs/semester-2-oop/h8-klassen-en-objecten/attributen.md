...
Een veld krijgt normaal de defaultwaarde voor zijn type. [Defaultwaarden](https://github.com/v-nys/cursusprooo/blob/master/semester-2-oop/h8-klassen-en-objecten/broken-reference/README.md) hebben we reeds gezien. Het is mogelijk de beginwaarde aan te passen met de syntax voor een toekenning:
